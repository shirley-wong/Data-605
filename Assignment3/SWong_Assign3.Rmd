...
If the matrix is non-zero, the maximum rank is the smaller value between the number of rows and the number of columns of the matrix. Given $m>n$, the maximum rank would be $n$.
